				  ...
				  <div class="row">
					  <div class="col-lg-9 main-chart">
						...
						<?php
							...
							$sqlrecommande="insert into recommander (IDM,IDMRE,IDC)
							values (?,?,?)";
							$ordresqlrecommande=mysqli_prepare($session,$sqlrecommande);
							mysqli_stmt_bind_param($ordresqlrecommande,"sss",$_SESSION['idm'],$_GET["idm"],$_GET["competence"]);
							
							if(mysqli_stmt_execute($ordresqlrecommande)!==0)
							{
								echo "Votre recommandation a été pris en compte.";
							}	
							echo "<p><a href='mescollegues.php'><button id='Retour' >Ok</button></a></p>"
