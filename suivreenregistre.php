					  ...
					  <div class="col-lg-9 main-chart">
						...
						<?php
							...
							$session=connectBD("root","root");
								...
								$sqlajout="insert into ajout_membre (IDM,IDMDE)
								 values (?,?)";
								$ordresqlajout=mysqli_prepare($session,$sqlajout);
								mysqli_stmt_bind_param($ordresqlajout,"ss",$_SESSION['idm'],$_GET["idm"]);	
								
								if(mysqli_stmt_execute($ordresqlajout)!==0)
								{
									echo "Vous suivez maintenant ce membre.";
								}
