					  ...
					  <div class="col-lg-9 main-chart">
						<?php
							...
							//supprimer le commentaire
								...
								$sqlsupprime="SET foreign_key_checks = 0";
								$sqlsupprime1="delete from commentaires where CODECOM='".$_GET['codecom']."'";
								$sqlsupprime2="SET foreign_key_checks = 1";
								mysqli_query ($session,$sqlsupprime);
								mysqli_query ($session,$sqlsupprime1);
								mysqli_query ($session,$sqlsupprime2);
			
									echo "<p>Ce commentaire est supprimé.</p>";
									echo "<p><button><a href='mescommantaires.php'>Ok</a></button></p>";
